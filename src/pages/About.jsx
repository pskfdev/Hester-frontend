  ...
  return (
    <div className="w-full py-20 text-slate-600">
      ...
      <div
        ...
        className="h-screen w-full shadow-xl"
      ></div>

      <div className="w-100 lg:w-2/4 mx-auto my-60 px-5 lg:px-0">
        <h1 className="text-4xl font-bold">
          Hester produces fresh, organic produce from local farmers in New York.
          Even our spices are fresh. Just because pickling is a preservation
          process doesn’t mean you can use dried-up thyme or week-old asparagus
          that’s already a little spongy.
        </h1>
        <p className="mt-10 text-2xl">
          We want to give our customers crisp, crunchy and delicious pickled
          vegetables and fruits. Most of all, we want to expand people’s palates
          and prove that pickles don’t always come in a green or red variety.
        </p>
      </div>
    </div>
  );
